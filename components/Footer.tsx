          ...
          <div className="grid grid-cols-2 gap-6">
            ...
            <div>
              ...
              <ul className="mt-4 space-y-2 text-sm text-gray-600">
                ...
                <li>
                  <Link href="/api" className="text-gray-700 transition-colors hover:text-gold">
                    API
                  </Link>
                </li>
              </ul>
      ...
      <div className="border-t border-gray-200">
        <div className="mx-auto flex max-w-7xl flex-col gap-3 px-4 py-4 text-xs text-gray-500 sm:flex-row sm:items-center sm:justify-between sm:px-6 lg:px-8">
          ...
          <div className="flex flex-wrap items-center gap-4">
            <Link href="/privacy" className="text-gray-700 transition-colors hover:text-gold">
              Конфиденциальность
            </Link>
            <span className="hidden h-3 w-px bg-gray-200 sm:inline-block" />
            <Link href="/terms" className="text-gray-700 transition-colors hover:text-gold">
